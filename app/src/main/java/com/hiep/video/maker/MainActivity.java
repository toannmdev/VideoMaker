...
//    }
    ...
    private void createVideoByFrame() {
        ...
        File[] files = new File(FileUtil.getImageInput()).listFiles();
        for (File file : files) {
            Log.e("ToanNM", "MainActivity -> listFile -> " + file);
        }

        String pathInputImage = FileUtil.getImageInput() + "/%d.jpg";

        Logger.d("Size input frame: " + size + ", pathInputImage -> " + pathInputImage);
...
//        execFFmpegBinary(FFmpegCmdUtil.cmdAddsticker(pathInputImage, outputSlideVideo,
//                Environment.getExternalStorageDirectory() + "/Download/emotion_14.png",
//                60, 60, 0, 3), KEY_CMD_CREATE_VIDEO);
    }
        ...
        try {
            ffmpeg.execute(command, new ExecuteBinaryResponseHandler() {
                ...
                public void onFailure(String s) {
                    Log.e("ToanNM", "________MainActivity onFailure -> " + s);
