...
public class AddStickerActivity extends BaseActivity implements SurfaceHolder.Callback,DemoPlayer.Listener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ToanNM", "AddStickerActivity....");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.ll_video_gif_done:
                Log.e("ToanNM", "ll_video_gif_done ");
...
//                    Logger.d("Started onFailure : ffmpeg "+s);
                }

                @Override
                public void onSuccess(String s) {
//                    Logger.d("Started onSuccess : ffmpeg "+s);
                }

                @Override
                public void onProgress(String s) {
//                    Logger.d("Started onProgress : ffmpeg ");
                    progressDialog.setMessage("Processing\n"+s);
                }

                @Override
                public void onStart() {
//                    Logger.d("Started onStart : ffmpeg " + command);
                    progressDialog.setMessage("Processing...");
                    progressDialog.show();
                }
...
//                    Logger.d("Finished onFinish : ffmpeg "+command);
                    ...
                    if (listSticky.size()>0){
                        ...
                        Log.e("ToanNM", "before addFrameToVideo");
