...
//        String cmd="-i " + linkvideo + " -i " + linkSticker + " -filter_complex [0:v][1:v]overlay="+left+":"+top+":enable=between(t\\,"+startTime+"\\,"+endTime+") -vcodec mpeg4 -q:v 3 -acodec copy " + linkOutput;
        ...
        builder.append("-i ");
        builder.append(linkvideo);
        builder.append(" -i ");
        builder.append(linkSticker);
        builder.append(" -filter_complex [0:v][1:v]overlay=");
        builder.append(left);
        builder.append(":");
        builder.append(top);
        builder.append(":enable='between");
        builder.append("(t");
        builder.append(",");
        ...
        builder.append(")' ");
        builder.append("-vcodec mpeg4 -q:v 3 -acodec copy ");
        builder.append(linkOutput);

//        String cmd = builder.toString();

        Log.e("ToanNM", "cmdAddsticker cmd -> " + cmd);
        String[] command = cmd.split(" ");
        return command;
    }
}
